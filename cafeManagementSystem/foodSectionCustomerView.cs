...
namespace cafeManagementSystem
{
    public partial class foodSectionCustomerView : Form
    {
        ...
        {
            connectionString = "Data Source=DESKTOP-4UBGI0P\\SQLEXPRESS;Initial Catalog=CafeSystem;Integrated Security=True";
        ...
        //{
        //    SqlConnection sql = new SqlConnection("Data Source=DESKTOP-4UBGI0P\\SQLEXPRESS;Initial Catalog=CafeSystem;Integrated Security=True");
        //    sql.Open();
        ...
        //            string description = reader["ItemDes"].ToString();
        //            string availability = reader["ItemAvailibility"].ToString();
        //            string inCart = 0.ToString();
        //            string price = "";

        //            // Fetch BasePrice for the current item
        //            string priceQuery = "select BasePrice from Pricing " +
        //                                "join Items on Pricing.PricingID = Items.priceid " +
        //                                "where Items.itemID = " + itemID;

        //            using (SqlCommand priceCmd = new SqlCommand(priceQuery, sql))
        //            {
        ...
        //            FoodSection.Rows.Add(itemID, itemName, description, availability, price, inCart);
        //            i++;
        //        }
        //    }
        //    else
        ...
        public void PopulateData()
        {
            ...
            //    "Data Source=DESKTOP-4UBGI0P\\SQLEXPRESS;" +
            //    "Database=Task;" +
            ...
            if (reader.HasRows)
            {
                ...
                while (reader.Read())
                {
                    ...
                    //string Newquery = "select BasePrice from Pricing join Items on Pricing.PricingID = Items.priceid where Items.itemID = " + reader["itemID"];
                    size++;
                }
                reader.Close();
                //FoodSection.Rows.Add(ItemID, ItemName, Descreption, Availibility, "", in_cart);
        ...
        static bool TupleExists(int orderId, int itemId)
        {
            ...
            using (SqlConnection connection = new SqlConnection("Data Source=DESKTOP-4UBGI0P\\SQLEXPRESS;Initial Catalog=CafeSystem;Integrated Security=True"))
            {
                connection.Open();
        ...
        private void FoodSection_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (FoodSection.Columns[e.ColumnIndex].HeaderText == "Add to Cart") //id add to cart is clicked
            {
                ...
                //string query = "SELECT * FROM OrderedItems WHERE OrderID = @OrderID AND itemID = @itemID";




                // Replace "your_order_id" and "your_item_id" with the values you want to check and insert
